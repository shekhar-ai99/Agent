...
class ATRSuperAlphaTrendStrategy(BaseStrategy):
    def __init__(
        ...
        **params
        ...
        self.params.setdefault("rsi_lower", 40)
        self.params.setdefault("rsi_upper", 60)
        self.params.setdefault("atr_threshold", 0.5)

    def required_indicators(self):
        return ["rsi_14", "supertrend_10_3.0", "atr_14", "close"]
